...
const Layout: FunctionComponent<{
	...
	description?: string;
	navigation: NavItem[];
}> = function ({ children, title, description, navigation }) {
		...
		<div className="min-h-full">
			<Disclosure as="nav" className="bg-white border-b border-gray-200">
				{({ open }) => (
					<>
						<Container>
							<div className="flex justify-between xl:justify-center h-24 xl:w-full xl:relative">
								<div className="flex">
									<div className="flex-shrink-0 flex items-center mr-12 xl:mr-auto xl:absolute xl:left-0 -top-[7px]">
										<Logo />
									</div>
