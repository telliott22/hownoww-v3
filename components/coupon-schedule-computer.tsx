...
const CouponScheduleComputer: FunctionComponent = () => {
                                    ...
                                    bondGroups.map(bondGroup => {
                                        ...
                                        return(
                                            <optgroup key={bondGroup.issuerType} label={bondGroup.issuerType.toUpperCase()}>
                                                ...
                                                {
                                                    bondGroup.bonds &&
                                                    bondGroup.bonds.map(bond => {

                                                        return <option key={bond._id} value={bond.slug}>{bond.title}</option>
