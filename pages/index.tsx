...
const Home: NextPage<{bonds:Bond[]}> = ({bonds}) => {
  return (
    <Page>
      ...
      <Container>
        ...
        <div className="space-y-20">
          ...
          <BondTable title={'Nigerian Government Eurobonds'} bonds={bonds} />

          <BondTable title={'Ghanaian Government Eurobonds'} bonds={bonds} />

          <BondTable title={'Angolan Government Eurobonds'} bonds={bonds} />

          <BondTable title={'Nigerian Bank Eurobonds'} bonds={bonds} />

          <BondTable title={'Expired Eurobonds'} bonds={bonds} />
